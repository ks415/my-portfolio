            ...
            <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-gray-200 p-6 rounded-lg shadow-md">
                        <Link href="https://todo-react-bice-xi.vercel.app/" target="_blank" rel="noopener noreferrer">
                            <div className="cursor-pointer">
                                ...
                                <h3 className="text-2xl font-bold mb-2 hover:text-gray-600 transition-colors">TODOリスト</h3>
                            </div>
                        </Link>
                        <p className="text-gray-700">シンプルなTODOリスト</p>
                    </div>
                    <div className="bg-gray-200 p-6 rounded-lg shadow-md">
                    ...
                    <div className="bg-gray-200 p-6 rounded-lg shadow-md">
                        <Link href="https://github.com/ks415" target="_blank" rel="noopener noreferrer">
                            <div className="cursor-pointer">
                                <div className="w-full h-60 mb-4">
                                    <img 
                                        src="/apple.jpg" 
                                ...
                                <h3 className="text-2xl font-bold mb-2 hover:text-gray-600 transition-colors">Project 3</h3>
                            </div>
                        </Link>
